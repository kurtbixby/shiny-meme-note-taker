...
// Handles GET requests to /notes
// Just returns the parsed DB file
router.get('/notes', (req, res) => {
    readFromFile(DB_LOCATION).then((data) => res.json(JSON.parse(data)));
});

// Handles POST requests to /notes
...
// Handles DELETE requests to /notes/noteId
// Searches through the array of notes from the db file and
// splices out the element with that id
